...
public record CollectionResponse(UUID id,String slug,String title,String originalTitle,String description,String type,String sourceMode,String status,String posterUrl,String backdropUrl,List<FranchiseSummaryResponse> franchises,List<SectionResponse> sections,List<ItemResponse> items,ViewerResponse viewer,List<SourceItemResponse> sourceItems,String requestedLocale,String resolvedLocale,boolean translationFallback) {
 ...
 public record SourceItemResponse(String provider,String externalId,UUID mediaId,String title,String coverUrl,java.time.LocalDate releaseDate,int position,String state) {}
}
